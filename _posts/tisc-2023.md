---
title: TISC 2023 writeups
date: 2 Oct 2023
---

TISC 2023 was a 15-day long CTF that had a unique ring system. I cleared till Level 8 and got $500 out of it - 19 other participants shared the $10k prize pool.
...
- [challenge.tar.xz](/files/tisc-2023/disk-archaeology/challenge.tar.xz)
...
![FTK Imager](/images/tisc-2023/ftk-imager.png)
...
- [chall](/files/tisc-2023/reckless/chall)
- [prog.c](/files/tisc-2023/reckless/prog.c)
...
![jadx](/images/tisc-2023/jadx.png)
...
![ida](/images/tisc-2023/ida64.png)
...
- [rubg.AppImage](/files/tisc-2023/rubg/rubg.AppImage)
- [rubg.exe](/files/tisc-2023/rubg/rubg.exe)
...
Final AppImage: [test.AppImage](/files/tisc-2023/rubg/test.AppImage)

Below image shows the wonderfully flagged out tiles for me to click:

![too easy](/images/tisc-2023/rubg.png)
...
![workflow](/images/tisc-2023/github-workflow.png)
...
![chosen-ones](/images/tisc-2023/chosen-ones.png)
...
![list tables](/images/tisc-2023/list-tables.png)

`0%20union%20select%20flag,%201,%201,%201%20from%20CTF_SECRET%20--%20`

![flag](/images/tisc-2023/yeet.png)
...
![flag2](/images/tisc-2023/flag2.png)
...
Files:
- [Dockerfile](/files/tisc-2023/blind-sqli/Dockerfile)
- [db-init.sql](/files/tisc-2023/blind-sqli/db-init.sql)
- [server.js](/files/tisc-2023/blind-sqli/server.js)
...
![nice-pug](/images/tisc-2023/nice-pug.png)
...
The above function generates a pre-signed token to download the `craft-query` lambda source as a zip. In the zip was a .wasm file and the meat of the challenge: [site.wasm](/files/tisc-2023/blind-sqli/site.wasm).

Using [the loader script](/files/tisc-2023/blind-sqli/index.js) (it's somewhat edited but I used it to fuzz and im too lazy to get the original file back), I realized that the program crashes with a suspicious message when i = 67:
